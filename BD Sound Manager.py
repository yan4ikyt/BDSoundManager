...
parser.add_argument("-i", "--ind", help="Index of VAG", type=int)
...
if mode == 'e':
    ...
    target_vag_index = args.ind
    if target_vag_index > max_vag_index:
        print("Specified sample index exceeds max index")
        sys.exit(1)
    ...
    with open(bd_path, "rb+") as file:
        ...
        while True:
            ...
            if file.peek(1) != b"\x01":
                file.write(b"\x01")
                print('Writed 1 flag | BD Fix v.1.0 ')
